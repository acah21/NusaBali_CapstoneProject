...
import { initHomeEvents } from '../pages/home-page.js';
import { initAboutEvents } from '../pages/about-us.js';
import { initDestinationEvents } from '../pages/destination.js';
import { initCultureEvents } from '../pages/culture-page.js';
...
const router = async () => {
  ...
  if (main) {
    ...
    // Initialize MVP components for each page
    switch (path) {
      case '/':
      case '/home':
        initHomeEvents();
